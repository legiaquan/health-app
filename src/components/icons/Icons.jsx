export const MenuIcon = ({ width = '32px', height = '32px', className }) => (
  <svg
    width={width}
    height={height}
    className={className}
...
export const InfoIcon = ({ width = '32px', height = '32px', className }) => (
  <svg
    width={width}
    height={height}
    className={className}
...
export const MemoIcon = ({ width = '32px', height = '32px', className }) => (
  <svg
    width={width}
    height={height}
    className={className}
...
export const KnifeIcon = ({ width = '56px', height = '56px', className }) => (
  <svg
    width={width}
    height={height}
    className={className}
...
export const CupIcon = ({ width = '56px', height = '56px', className }) => (
  <svg
    width={width}
    height={height}
    className={className}
...
export const ArrowUpIcon = ({ width = '48px', height = '48px', className }) => (
  <svg
    width={width}
    height={height}
    className={className}
